...
class ComboEffectState extends State<ComboEffect>
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 24,
                      fontWeight: FontWeight.bold,
                      color: _getComboColor(widget.comboCount),
                      shadows: [
                        Shadow(
...
class AnimatedParticleState extends State<AnimatedParticle>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
...
class ComboManager {
  ...
  void incrementCombo(BuildContext context, {Offset? position}) {
    _currentCombo++;
    ...
    if (currentCombo >= 3) {
      _showComboEffect(context, position ?? const Offset(100, 100));
    }
